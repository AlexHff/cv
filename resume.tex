...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Passionate Software Engineer with Infrastructure expertise. & Mobile : +33 6 21 19 56 74
\end{tabular*}
...
\section{Professional experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{}
        {Designing, building, operating and maintaining modern data analytics platforms in the cloud and on-premise.}
      \resumeItem{}
        {Reviewing, auditing and troubleshooting existing solutions and system architectures.}
      \resumeItem{}
        {Ensuring high availability of key data systems including taking on-call responsibility.}
    \resumeItemListEnd
    \resumeSubheadingz
    {Software Engineer}{2021 -- 2022}
    \resumeItemListStart
      \resumeItem{}
        {Built a REST API to programmatically manage Hadoop clusters. It provides configuration and service lifecycle management, service health metrics, and setting up high availability and decommissioning.}
      \resumeItem{}
        {Worked on SSO integration, clustering interface support, and appliance stack management.}
      \resumeItem{}
        {Automated infrastructure provisioning, DevOps, and continuous integration/delivery using workflow orchestration tools.}
    \resumeItemListEnd
