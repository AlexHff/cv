...
\section{Academic experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Associate Professor of Computer Science}{Paris, France}
      {ECE Paris}{2020 -- 2021}
      \resumeItemListStart
        \resumeItem{}
          {Graduate student instructor for advanced undergraduate computer science courses.}
        \resumeItem{}
 ...
 \resumeSubHeadingListStart
 	...
 	\resumeSubItem{Languages}
   	...
   	\resumeSubItem{Athletics}
   		{: 2018 vice-champ in 100-metre dash, third place in triple jump at the regional level (Île-de-France).}
