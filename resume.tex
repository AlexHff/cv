...
\section{Technical Skills}
 \resumeSubHeadingListStart
 	...
 	\resumeSubItem{Languages (alphabetically)}
   		{: C, C++, HTML/CSS, Java, \LaTeX, Markdown, Python, ReactJS, SQL.}
   		
   	\resumeSubItem{OS}
   		{: Linux, Microsoft Windows.}
   		
   	\resumeSubItem{Software \& Technology}
   		{: AWS, Computer Vision, Databases, DevOps, Elasticsearch, Gatsby, Git, Hibernate, Maven, Networking, NodeJS, OpenCV, Travis CI, vim, Virtualization, Web Technologies, Wordpress.}
