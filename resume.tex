 ...
 \resumeSubHeadingListStart
 	...
 	\resumeSubItem{Languages (alphabetically)}
   	...
   	\resumeSubItem{Software \& Technology}
   		{: AWS, Computer Vision, Databases, DevOps, Elasticsearch, Gatsby, Git, Hibernate, Maven, Networking, NodeJS, OpenCV, vim, Virtualization, Web Technologies, Wordpress.}
