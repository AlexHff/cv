...
\section{Technical Skills}
 \resumeSubHeadingListStart
    ...
    \resumeSubItem{Languages (alphabetically)}
   		{: C, C++, HTML/CSS, Java, JavaScript, \LaTeX, Markdown, ReactJS.}
   	...
   	\resumeSubItem{Web technologies}
   		{: AWS, DevOps, Git, Java Spring, NodeJS, Shopify, Wordpress.}
   		
   	\resumeSubItem{Other Software \& Technologies}
   		{: Computer Vision (OpenCV), Networking, vim, Virtualization.}
