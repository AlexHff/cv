...
\section{Projects}
 \resumeSubHeadingListStart
 	...
 	\resumeSubItem{Docsight (Java) \href{https://github.com/AlexHff/docsight}{\texttt{[github]}}}
   		{: A tool for detecting text in an image using OpenCV.}
   	...
   	\resumeSubItem{Watermelon (ReactJS) \href{https://github.com/AlexHff/wenger-payment}{\texttt{[github]}}}
   		{: Simple payment app between individuals (locally).}
 ...
 \resumeSubHeadingListStart
 	\resumeSubItem{Languages}
   	...
   	\resumeSubItem{Software \& Technology}
   		{: VSCode, Eclipse, vim, Wireshark, Github, Maven, Oracle VM VirtualBox, GParted, OPNsense, REST API, Hibernate, Elasticsearch, Travis CI.}
 \resumeSubHeadingListEnd
